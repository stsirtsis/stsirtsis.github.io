...
👋🏼 **Hey there!** My name is Stratis, and I am a postdoc working with [Sandra Wachter](https://hpi.de/forschung/fachgebiete/technology-and-regulation/), [Chris Russel](https://www.oii.ox.ac.uk/people/profiles/chris-russell/), and [Brent Mittelstadt](https://www.oii.ox.ac.uk/people/profiles/brent-mittelstadt/). My research develops computational methods to understand and improve AI's social impact.
...
In a nutshell, if I were to put my research in boxes, the closest ones would be **game theory**, **causality**, and **optimization**. In practice, my work is application-driven and spans topics like incentives in generative AI markets, AI-assisted decision-making, explainability, and fairness. If you find these topics interesting, feel free to reach out!
