...
In a nutshell, if I were to put my research in boxes, the closest ones would be **game theory**, **causality**, and **optimization**. In practice, my work is interdisciplinary and spans topics like incentives in generative AI markets, AI-assisted decision-making, explainability, and fairness. If you find these topics interesting, feel free to reach out!